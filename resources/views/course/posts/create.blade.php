...
<div class="col-lg-8">
    <form method="post" action="/course/posts">
        @csrf
        ...
        <div class="form-group">
            <label for="body">Describe Course</label>
            <textarea class="form-control @error('body') is-invalid @enderror" id="body" rows="3" placeholder="Enter Description" name="body" required value="{{ old('body') }}"></textarea>
            @error('body')
            <div class="invalid-feedback">
            {{ $message }}
            @enderror
