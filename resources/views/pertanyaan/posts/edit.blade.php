...
<div class="col-lg-8">
    <form method="post" action="/pertanyaan/posts/{{ $post->slug }}">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control @error('body') is-invalid @enderror" id="body" rows="3" placeholder="Enter Description" name="body" required value="{{ old('body'), $post->body }}"></textarea>
            @error('body')
            <div class="invalid-feedback">
            {{ $message }}
            @enderror
